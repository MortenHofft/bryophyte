...
//   const popover = usePopoverState({hideOnClickOutside: true});
...
//         {props => popover.visible && <div {...props}>
...
const Parent = () => {
  ...
  return <div>
    ...
    >
      <Content count={tmpCount} setCount={setTmpCount} apply={() => setCount(tmpCount)} onCancel={() => setTmpCount(count)} />
    </Popover>
  </div>
}
